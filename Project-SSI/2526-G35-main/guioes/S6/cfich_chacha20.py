...
def setup(fkey):
    chave = os.urandom(32)  # 32 bytes para ChaCha20
...
def enc(fich, fkey):
    ...
    criptograma = encryptor.update(texto)
...
def dec(fich, fkey):
    ...
    texto = decryptor.update(criptograma)

    # Guardar texto decifrado
